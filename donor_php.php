...
$sql="INSERT INTO `donor` (`fname1`, `age1`, `gender1`, `bg1`, `add1`, `email1`, `cno1`, `ddate`, `id1`, `pd`,'new_date') VALUES ('$fname1','$age1','$gender1','$bg1','$add1','$email1','$cno1','$ddate','$id1','$pd','$new_date')";
$xyz=$conn->query($sql);
if($xyz==TRUE)
{
	...
	echo "<br>NEW-DATE : ",$_POST["new_date"];
